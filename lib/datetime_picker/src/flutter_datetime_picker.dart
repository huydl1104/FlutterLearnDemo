...
class _DatePickerRoute<T> extends PopupRoute<T> {
  _DatePickerRoute({
    ...
    BasePickerModel? pickerModel,
        ...
        theme = theme ?? const DatePickerThemeNew(),
  ...
  final DatePickerThemeNew theme;
...
//    print('refreshScrollOffset ${widget.pickerModel.currentRightIndex()}');
  ...
  Widget build(BuildContext context) {
    DatePickerThemeNew theme = widget.route.theme;
  ...
  Widget _renderPickerView(DatePickerThemeNew theme) {
  ...
  Widget _renderItemView(DatePickerThemeNew theme) {
    return Container(
      color: theme.backgroundColor,
  ...
  // Title View
  Widget _renderTitleActionsView(DatePickerThemeNew theme) {
