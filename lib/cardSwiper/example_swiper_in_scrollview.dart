              ...
              children: <Widget>[
                Container(
                  ...
                  child: Swiper(
                    ...
                    //     return CustomIndicator(config: config);
                    //   },
                    // ),
                    pagination: SwiperCustomPaginationNew(),
                  ),
                ),
                SizedBox(
                  height: 100.0,
...
class SwiperCustomPaginationNew extends SwiperPlugin {
  const SwiperCustomPaginationNew();
...
class CustomIndicator extends StatelessWidget {
  ...
  CustomIndicator({required this.config});
